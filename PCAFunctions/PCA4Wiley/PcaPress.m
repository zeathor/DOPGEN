function [F,R,Q,Cl,Cos2,d2,t,l,Ress_L,PRess_L,Q2,W,Ress_ell,PRess_ell] =...
               PcaPress(Xori,drapeau);
%USAGE function [F,R,Q,Cl,Cos2,d2,t,l,Ress,PRess,Q2,W,Rl,Pl] = PcaPress(X,'flag'); 
...
%        F =P*Delta
% R         Correlation variables/columns (Loadings as correlation)
%             NB Can create problem when #of columns is too big
%             If you have an "out of memory" error use BigPcaPress
